                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                >
                                    <i
                                        class="uil uil-transaction align-middle h5 mb-0 me-2"
                                    ></i>
                            ...
                            <div class="col-lg-3">
                                ...
                                >
                                    <i
                                        class="uil uil-shield-check align-middle h5 mb-0 me-2"
                                    ></i>
                                ...
                                <ul class="list-unstyled text-sm-end mb-0">
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0)"
                                            ><img
                                                src="{{ asset('assets') }}/images/payments/american-ex.png"
                                    ...
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0)"
                                            ><img
                                                src="{{ asset('assets') }}/images/payments/discover.png"
                                                class="avatar avatar-ex-sm"
                                                title="Discover"
                                                alt=""
                                        /></a>
                                    ...
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0)"
                                            ><img
                                                src="{{ asset('assets') }}/images/payments/master-card.png"
                                                class="avatar avatar-ex-sm"
                                                title="Master Card"
                                                alt=""
                                        /></a>
                                    ...
                                    <li class="list-inline-item">
                                        <a href="javascript:void(0)"
                                            ><img
                                                src="{{ asset('assets') }}/images/payments/visa.png"
                                                class="avatar avatar-ex-sm"
                                                title="Visa"
                                                alt=""
                                        /></a>
