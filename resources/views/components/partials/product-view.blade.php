								...
								<div class="col-lg-5">
									<div class="tiny-single-item">
										<div class="tiny-slide">
											<img
												src="{{ asset('assets') }}/images/shop/product/single-2.jpg"
										...
										<div class="tiny-slide">
											<img
												src="{{ asset('assets') }}/images/shop/product/single-3.jpg"
												class="img-fluid rounded"
												alt=""
											/>
										</div>
										<div class="tiny-slide">
											<img
												src="{{ asset('assets') }}/images/shop/product/single-4.jpg"
												class="img-fluid rounded"
												alt=""
											/>
										</div>
										<div class="tiny-slide">
											<img
												src="{{ asset('assets') }}/images/shop/product/single-5.jpg"
												class="img-fluid rounded"
												alt=""
											/>
										</div>
										<div class="tiny-slide">
											<img
												src="{{ asset('assets') }}/images/shop/product/single-6.jpg"
												class="img-fluid rounded"
												alt=""
											/>
										</div>
								...
								<div class="col-lg-7 mt-4 mt-lg-0 pt-2 pt-lg-0">
									...
									<div class="mt-4 pt-2">
										<a href="javascript:void(0)" class="btn btn-primary"
											>Shop Now</a
										>
										<a href="shop-cart.html" class="btn btn-soft-primary ms-2"
											>Add to Cart</a
										>
									</div>
								</div>
